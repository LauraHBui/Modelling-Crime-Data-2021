...
<!-- (do not understand this)... and see that the outliers has `r nrow(outliers)` rows (so `r nrow(outliers)` agencies that are outliers) while extreme_outliers has `r nrow(outliers_extreme)` rows (so `r nrow(outliers)` agencies that are extreme outliers)!  -->
