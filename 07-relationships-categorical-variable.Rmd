...
The output displays `r BCS0708 %>% group_by(sex) %>% dplyr::summarise(n = n()) %>% filter(sex == "male") %>% pull(n)` males and `r BCS0708 %>% group_by(sex) %>% dplyr::summarise(n = n()) %>% filter(sex == "female") %>% pull(n)` females. 
