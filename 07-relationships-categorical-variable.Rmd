...
Frequency distributions are a useful way of exploring categorical variables that do not have too many categories. **Cross-tabulations** are a type of contingency table that specifically  explores relationships between two categorical variables that do not have too many levels or categories. 
