...
We can conclude from our sample that the mean IQ for all probationers will be somewhere between `r mean(sample1$IQ, na.rm = TRUE) - 1.96*sd(sample1$IQ)/sqrt(100)` and `r mean(sample1$IQ, na.rm = TRUE) + 1.96*sd(sample1$IQ)/sqrt(100)`. 
