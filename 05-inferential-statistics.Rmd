...
The SE (of the mean) is `r sd(new_1000_sample$IQ)/sqrt(1000)`. How to interpret and communicate this estimate? A way of talking about this has to do with the *68-95-99 rule*.
