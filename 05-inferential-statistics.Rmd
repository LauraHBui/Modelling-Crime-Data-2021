...
With our sE above, and because we are dealing with the normal distribution, we can say that 95% of the sample will produce a mean which is within above or below 2 * `r sd(new_1000_sample$IQ)/sqrt(1000)`; in other words, within +/- `r 2*sd(new_1000_sample$IQ)/sqrt(1000)`, or within approximately one IQ point above and below the mean IQ for the whole population of 3.6 million probationers -- close to the true estimate.
