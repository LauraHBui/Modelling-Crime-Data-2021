...
The value is `r z_score`. This is a more precise approximation than our lookup table (where we had to round `r z_stat`), and so we are getting a more precise p-value. 
