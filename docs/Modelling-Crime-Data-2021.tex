...
For this section, we learn some hypothesis tests that use the \emph{normal distribution}.
...
\hypertarget{activity-10-single-sample-z-tests-for-proportions}{%
\subsubsection{Activity 10: Single Sample z-tests for Proportions}\label{activity-10-single-sample-z-tests-for-proportions}}
...
\hypertarget{activity-11-single-sample-t-tests-for-means}{%
\subsubsection{Activity 11: Single-sample t-tests for Means}\label{activity-11-single-sample-t-tests-for-means}}
