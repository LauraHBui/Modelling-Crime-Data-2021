...
The output shows the shaded area at 0.945325, meaning that the prisoner has a higher IQ than over 94.594% of the prison population. 
...
The officer conducts an IQ assessment of all 233 prisoners at their prison and finds average IQ is 101.5793991 (SD = 13.8144697). 
...
We obtained this test statistic of 1.7451616, but how can we interpret this? We can use z-test statistic to find *the associated p-value*.  
...
The value is 0.9595216. This is a more precise approximation than our lookup table (where we had to round 1.7451616), and so we are getting a more precise p-value. 
