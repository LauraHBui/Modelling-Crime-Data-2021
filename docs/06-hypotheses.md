...
The officer conducts an IQ assessment of all 233 prisoners at their prison and finds average IQ is 100.2961373 (SD = 14.8791926). 
...
We obtained this test statistic of 0.3038028, but how can we interpret this? We can use z-test statistic to find *the associated p-value*.  
...
The value is 0.6193609. This is a more precise approximation than our lookup table (where we had to round 0.3038028), and so we are getting a more precise p-value. 
