...
The output shows the shaded area at 0.9451326, meaning that the prisoner has a higher IQ than over 94.594% of the prison population. 
...
The officer conducts an IQ assessment of all 233 prisoners at their prison and finds average IQ is 99.4849785 (SD = 15.0899883). 
...
We obtained this test statistic of -0.520972, but how can we interpret this? We can use z-test statistic to find *the associated p-value*.  
...
The value is 0.3011931. This is a more precise approximation than our lookup table (where we had to round -0.520972), and so we are getting a more precise p-value. 
