...
The output shows the shaded area at 0.9451573, meaning that the prisoner has a higher IQ than over 94.594% of the prison population. 
...
The officer conducts an IQ assessment of all 233 prisoners at their prison and finds average IQ is 98.9399142 (SD = 15.1454384). 
...
We obtained this test statistic of -1.068408, but how can we interpret this? We can use z-test statistic to find *the associated p-value*.  
...
The value is 0.1426682. This is a more precise approximation than our lookup table (where we had to round -1.068408), and so we are getting a more precise p-value. 
